...
@bi.route('/embed-token-prov/<id>', methods=["POST"])
@jwt_required()
@cross_origin()
def get_embed_token_prov(id):
    user = id
    access_token = get_service_principal_token()
    ...
    url = f"https://api.powerbi.com/v1.0/myorg/groups/{GROUP_ID}/reports/{REPORT_ID_PROV}/GenerateToken"
    ...
    embed_url = f"https://app.powerbi.com/reportEmbed?reportId={REPORT_ID_PROV}&groupId={GROUP_ID}"
